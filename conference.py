...
from models import Profile, ConferenceQueryForms, ConferenceForms
...
class ConferenceApi(remote.Service):
    ...
    def _doProfile(self, save_request=None):
        ...
        # if saveProfile(), process user-modifable fields
        if save_request:
    ...
    def getConferencesToAttend(self, request):
        ...
        # my_websafe_key_string = user.conferenceKeysToAttend
        # wsck = request.websafeConferenceKey
        # conf = ndb.Key(urlsafe=wsck).get()
        ...
        # conferences = get_multi(ndb.Key(urlsafe=my_websafe_key_string))
        conferences = get_multi(user.conferenceKeysToAttend)
